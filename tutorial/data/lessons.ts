  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        instruction: 'Click on the "Loops" category and find the "count with i from 1 to 10" block.',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        instruction: 'Click on the "Setup" category (indigo) in the toolbox to see available blocks.',
        highlightBlocks: ['nav_arm'],
        hints: ['Look for the indigo "Setup" category', 'It should be at the top of the toolbox'],
      },
      {
        id: 'drag-arm-block',
