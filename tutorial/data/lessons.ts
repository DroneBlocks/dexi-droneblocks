  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        instruction: 'From the "Variables" category, drag the "i" variable block and place it in the LED pixel\'s index slot.',
        highlightBlocks: ['variables_get'],
        hints: ['The "i" variable holds the current count (0, 1, 2, ... 44)', 'This makes each loop iteration light a different LED'],
      },
      {
        id: 'set-color-white',
