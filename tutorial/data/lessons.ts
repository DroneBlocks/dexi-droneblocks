...
export const lessons: TutorialLesson[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        instruction: 'Click "▶ Run Mission" and watch the right panel as your drone takes off in the simulator!',
        highlightElement: '.run-btn',
      },
      {
        id: 'observe-flight',
  ...
  },
  {
    ...
    estimatedMinutes: 4,
    icon: '💡',
    completionMessage: 'Colorful! You can now add visual effects to your drone.',
    steps: [
      {
        id: 'led-intro',
        title: 'LED Ring Control',
        description: 'Your drone has an LED ring that can display colors and effects.',
        instruction: 'LEDs are great for visual feedback, status indication, or just making your drone look cool! No flying required for this tutorial.',
        autoAdvance: false,
      },
      {
      ...
      },
      {
        ...
        instruction: 'Drag the "LED effect" block onto the workspace. Click the dropdown to choose an effect like "rainbow" or "pulse".',
        highlightBlocks: ['led_effect'],
      ...
      {
        id: 'run-with-leds',
        title: 'Run Your LED Mission',
        description: 'Execute the LED commands.',
        instruction: 'Click the Launch button to run your LED mission. Watch your drone light up!',
        highlightElement: '.primary-btn',
      },
    ],
  },
  {
    id: 'lesson-5b-led-loop',
    title: 'LED Pixel Animation with Loops',
    category: 'beginner',
    description: 'Use a loop to light up each LED pixel individually, creating a chase effect around the ring.',
    estimatedMinutes: 6,
    icon: '🔄',
    completionMessage: 'Awesome! You\'ve created an LED chase animation using loops and individual pixel control.',
    steps: [
      {
        id: 'loop-led-intro',
        title: 'Individual LED Control',
        description: 'The LED ring has 12 individual pixels that can each be set to different colors.',
        instruction: 'In this tutorial, you\'ll use a loop to set each pixel to white one at a time, creating a chase effect around the ring. No flying required!',
        autoAdvance: false,
      },
      {
        id: 'find-loop-block',
        title: 'Find the Loop Block',
        description: 'We\'ll use a counting loop to iterate through all 12 pixels.',
      ...
      },
      {
        ...
        instruction: 'Drag the "count with i" block onto the workspace. Change the numbers to count from 0 to 11 (for 12 LEDs, numbered 0-11).',
        highlightBlocks: ['controls_for'],
        hints: ['Click on the numbers to change them', 'LEDs are numbered 0 through 11'],
      },
      {
        id: 'find-pixel-block',
      ...
      },
      {
        ...
        description: 'Instead of a fixed index, use the loop counter.',
        instruction: 'From the "Variables" category, drag the "i" variable block and place it in the LED pixel\'s index slot (replacing the number).',
        highlightBlocks: ['variables_get'],
        hints: ['The "i" variable holds the current count (0, 1, 2, ... 11)', 'This makes each loop iteration light a different LED'],
      },
      {
        id: 'set-color-white',
        title: 'Set Color to White',
        description: 'Set the RGB values to create white light.',
        instruction: 'Set the Red, Green, and Blue values all to 255. This creates white light (full brightness on all colors).',
        hints: ['White = Red 255, Green 255, Blue 255', 'Click each number to change it'],
      },
      {
        id: 'add-wait',
        title: 'Add a Small Delay',
        description: 'Add a wait so you can see each LED light up.',
        instruction: 'From the "Navigation" category, add a "Wait" block inside the loop, after the LED pixel block. Set it to 0.5 seconds.',
      ...
      },
      {
        id: 'experiment',
        title: 'Experiment!',
        description: 'Try variations of this animation.',
        instruction: 'Try changing the color values to create different effects. You could also add an "LED ring off" block after the wait to create a single-LED chaser effect!',
        autoAdvance: false,
      },
    ],
  },
